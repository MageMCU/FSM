...
void EnterMineAndDigForNugget::Enter(Miner *pMiner)
{
  ...
  if (pMiner->Location() != goldmine)
  {
    ...
    Serial.print(GetNameOfEntity(pMiner->ID()));
    Serial.println(": Walkin' to the goldmine");
...
void EnterMineAndDigForNugget::Execute(Miner *pMiner)
{
  ...
  Serial.print(GetNameOfEntity(pMiner->ID()));
  Serial.println(": Pickin' up a nugget");
...
void EnterMineAndDigForNugget::Exit(Miner *pMiner)
{
  ...
  Serial.print(GetNameOfEntity(pMiner->ID()));
  Serial.println(": Ah'm leavin' the goldmine with mah pockets full o' sweet gold");
}
...
void VisitBankAndDepositGold::Enter(Miner *pMiner)
{
  ...
  if (pMiner->Location() != bank)
  {
    ...
    Serial.print(GetNameOfEntity(pMiner->ID()));
    Serial.println(": Goin' to the bank. Yes siree");
...
void VisitBankAndDepositGold::Execute(Miner *pMiner)
{
  ...
  Serial.print(GetNameOfEntity(pMiner->ID()));
  Serial.print(": Depositing gold. Total savings now: ");
  Serial.println(pMiner->Wealth());
  ...
  if (pMiner->Wealth() >= ComfortLevel)
  {
    ...
    Serial.print(GetNameOfEntity(pMiner->ID()));
    Serial.println(": WooHoo! Rich enough for now. Back home to mah li'lle lady");
...
void VisitBankAndDepositGold::Exit(Miner *pMiner)
{
  ...
  Serial.print(GetNameOfEntity(pMiner->ID()));
  Serial.println(": Leavin' the bank");
}
...
void GoHomeAndSleepTilRested::Execute(Miner *pMiner)
{
  ...
  if (!pMiner->Fatigued())
  {
    ...
    Serial.print(GetNameOfEntity(pMiner->ID()));
    Serial.println(": What a God darn fantastic nap! Time to find more gold");
...
void GoHomeAndSleepTilRested::Exit(Miner *pMiner)
{
  ...
  Serial.print(GetNameOfEntity(pMiner->ID()));
  Serial.println(": Leaving the house ");
}
...
void QuenchThirst::Enter(Miner *pMiner)
{
  if (pMiner->Location() != saloon)
  {
    ...
    Serial.print(GetNameOfEntity(pMiner->ID()));
    Serial.println(": Boy, ah sure is thusty! Walking to the saloon");
  }
}
...
void QuenchThirst::Execute(Miner *pMiner)
{
  if (pMiner->Thirsty())
  {
    ...
    Serial.print(GetNameOfEntity(pMiner->ID()));
    Serial.println(": That's mighty fine sippin' liquer");
...
void QuenchThirst::Exit(Miner *pMiner)
{
  ...
  Serial.print(GetNameOfEntity(pMiner->ID()));
  Serial.println(": Leaving the saloon, feelin' good");
}
